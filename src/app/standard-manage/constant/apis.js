...
export const API_UPDATE_SINGLE = API_SERVER + '/standard/updateSingle'
export const API_DELETE_STANDARD = API_SERVER + '/standard/delete'
export const API_DELETE_SINGLE = API_SERVER + '/standard/deleteSingle'
